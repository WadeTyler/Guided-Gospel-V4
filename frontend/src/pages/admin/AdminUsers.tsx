        ...
        <div className="overflow-x-auto overflow-y-scroll">
          <div className="bg-neutral-800 dark:bg-darkaccent rounded-lg shadow-lg">
            ...
            <div className="divide-y divide-gray-700">
              {users.map((user) => (
                <div key={user.userid} 
                className={`grid grid-cols-8 text-gray-200 py-2 px-4 hover:bg-zinc-500 transition-all duration-200 cursor-pointer ${user.suspended ? 'text-red-500' : ''} ${user.flagscore > 50 ? 'text-orange-400' : ''}`} 
                onClick={() => {
