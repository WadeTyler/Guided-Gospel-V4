    ...
    <div className="flex md:flex-row flex-col-reverse items-center justify-center w-full min-h-screen md:gap-16 gap-8 bg-white dark:bg-darkbg">
      ...
      <div className="form-container !h-full dark:text-darktext">
        ...
        <section>
          ...
          <p>By default Guided Gospel provides a limit of 12 messages per day. Once, you send 12 messages, you will no longer be able to send any more. Because Guided Gospel is a free service, a daily limit is in place to prevent malicious users from abusing our service.</p>
        </section>

        <section>
          <p className="text-xl">How do I get more?</p>
          <p>Daily Limits reset at 12:00 AM EST (Midnight) every night. At the moment, there currently is no official way to get more than 12 message rates per day, but there is plans for in the future.</p>
        </section>
